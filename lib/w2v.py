...
class W2V():
    """
    Apply word2vec to a TOKEN table with OHCO index with n and pos columns. 
    Returns a word embedding model and a tSNE projection, 
    as well as method to visualize the results in Plotly.
    """
    ...
    def generate_model(self):
        ...
        print("Computing tSNE coordinates")
