...
class TopicModel():            
    ...
    Attributes:
        ...
        n_top_terms (int): The number of top terms to use to represent each topic. 
                           Will compute based on entropy if no value given. Defaults to None.
        ...
        # LDA Params
        max_iter (int): The number if iterations for the model to run. Defaults to 20.
        learning_offset (float): The learning offset. Defaults to 50.0.
        random_state (int): The random state number. Defaults to 0.
        
        # NMF Params
        nmf_init(str): Initial decomposition method. Defaults to 'nndsvd'.
        nmf_max_iter (int): The number if iterations for the model to run. Defaults to 1000.
        nmf_random_state (int): The random state number. Defaults to 1.

        kw ({}): A dictionary of parameters to pass through to called engine.
